...
!(function(h) {
  ...
  var e,
    ...
    $n = function(n, e) {
      var t,
        ...
        v = Ln(p, n).fold(jn.unknown, jn.nu)
      return {
        browser: h,
        os: v,
        deviceType:
      ...
      if (se() && x(n.target)) {
        ...
        if (tn(e) && he(Sn.fromDom(n.target))) {
          if (n.composed && n.composedPath) {
            ...
            if (t) return 0 === (r = t).length ? S.none() : S.some(r[0])
          }
        }
      }
      var r
  ...
  var $t = function(r, o, n, e) {
      ...
      return Zn(l, f)
        ...
        : Zt(l).bind(function(a) {
            return Zt(f).bind(function(u) {
              ...
              if (ee(a, u)) {
                var n =
                  0 < (e = Le(f, 'td,th', d(a))).length ? e[e.length - 1] : f
                return S.some({ boxes: qt(a, l, a, f, u), start: l, finish: n })
              }
              if (ee(u, a)) {
                var e,
                  t =
                    0 < (e = Le(l, 'td,th', d(u))).length ? e[e.length - 1] : l
                return S.some({ boxes: qt(u, l, a, f, u), start: l, finish: t })
              }
              return Yt(Jt, l, f, r)
                .shared()
                .bind(function(n) {
      ...
      return {
        ...
        unmergable: b(
          0 < (r = Sr(t, n)).length &&
            L(r, function(n) {
              return (
                (dn(n, 'rowspan') && 1 < parseInt(fn(n, 'rowspan'), 10)) ||
                (dn(n, 'colspan') && 1 < parseInt(fn(n, 'colspan'), 10))
              )
            })
            ? S.some(r)
            : S.none()
    ...
    Pr = function(n) {
      var e = S.from(n.dom().documentElement)
        .map(Sn.fromDom)
        .getOr(n)
  ...
  var Mr = Er('height', function(n) {
    ...
    to = function(r, o) {
      ...
      var n = r[o].fold(
          function() {
            var n,
              e,
              t = ((n = r.slice(0, o)), (e = O.call(n, 0)).reverse(), e)
    ...
    nu = function(n, e, u, i) {
      ...
      return o.fold(
        ...
        function(n, e) {
          if (0 <= u) return a(c.slice(0, e)).concat([u])
          var t = Math.max(i.minCellWidth(), c[e] + u)
    ...
    pu = function(n) {
      0 === (su(n) ? n.dom().classList : fu(n, 'class')).length &&
        mn(n, 'class')
    },
    hu = function(n, e) {
  ...
  var Bu = function(e, t, n) {
      ...
      return (
        c.on('init', function() {
          var n,
            e,
            t = Go(Ti),
            r = (n = c).inline ? kr(gi(n), ji()) : Pr(Sn.fromDom(n.getDoc()))
          if (
            ((f = S.some(r)),
    ...
    Yi = function(o, n) {
      var u = [],
        i = [],
        c = H(He(o, 'caption,colgroup')).fold(
          function() {
            return y(Ae, o)
          },
          function(n) {
    ...
    Dc = function(n, e, t, r, o) {
      ...
      return a
        .slice(0, n)
        .concat(i)
        .concat(a.slice(n, a.length))
    },
    Ac = function(t, r, n, o, u) {
      var e = t.slice(0, r),
        i = t.slice(r),
        c = Zi(t[n], function(n, e) {
          return 0 < r && r < t.length && o(ec(t[r - 1], e), ec(t[r], e))
            ? nc(t[r], e)
            : je(u(n.element(), o), !0)
        })
    ...
    Pc = function(n, e, t, r) {
      return (
        ec(n[e], t) !== undefined && 0 < e && r(ec(n[e - 1], t), ec(n[e], t))
      )
    },
    kc = function(n, e, t) {
      ...
      return {
        combine: function(e) {
          return (
            ...
            function() {
              var n = t.cell({ element: b(e), colspan: b(1), rowspan: b(1) })
      ...
      function(n, t, e, r) {
        var o,
          ...
          l =
            ...
            (i = mt.fromTable(o)),
            ic(i, u, !0)),
          f = ((c = t.row()), (a = t.column()), { row: b(c), column: b(a) })
    ...
    xa = function(n, e, t) {
      ...
      if ('header' === t) {
        ...
        Sa(o, e.cells, 'td', null), Ca(o, e, 'footer' === t ? 'tfoot' : 'tbody')
    },
    Ta = function(e) {
      return {
        get: function() {
          ...
          .map(function(n) {
            ...
            return (
              li(o)
                ...
                : fi(o)
                ? Wi(n)
                : (ai(o) || ((e = u.width), m(e) && -1 !== e.indexOf('%'))) &&
                  Ni(o, n),
              wi(n),
              mn(n, 'data-mce-id'),
              (t = o),
    ...
    $a = function(n, e) {
      ...
      return {
        ...
        bordercolor: Te(t, 'border-color')
          .map(Ka(n))
          .getOr(''),
        backgroundcolor: Te(t, 'background-color')
          .map(Ka(n))
          .getOr('')
      }
    },
    ...
    el = function(n) {
      return (0 <
      (e = Ua(n.getParam('table_cell_class_list', [], 'array'))).length
    ...
    ol = function(d, n, m) {
      ...
      E(n, function(n) {
        var e,
          ...
          s = p ? rl.normal(d, f) : rl.ifTruthy(d, f)
        ;(t = m),
    ...
    al = function(n) {
      return (0 <
      (e = Ua(n.getParam('table_row_class_list', [], 'array'))).length
        ? S.some({ name: 'class', type: 'selectbox', label: 'Class', items: e })
        : S.none()
      ).fold(
        function() {
    ...
    ll = function(i, n, c, a) {
      ...
      E(n, function(n) {
        ...
        var e,
          ...
          r,
          o,
          u = l ? rl.normal(i, n) : rl.ifTruthy(i, n)
        ;(t = a),
    ...
    ml = function(n, e, t, r) {
      if ('TD' === e.tagName || 'TH' === e.tagName)
        ...
        for (var o = 0; o < e.children.length; o++) ml(n, e.children[o], t, r)
    },
    gl = function(t, r, n) {
      var o,
        u = t.dom,
    ...
    ql = document.caretPositionFromPoint
      ? function(t, n, e) {
          return S.from(t.dom().caretPositionFromPoint(n, e)).bind(function(n) {
            if (null === n.offsetNode) return S.none()
            var e = t.dom().createRange()
      ...
      : function(o, u, e) {
          return Sn.fromPoint(o, u, e).bind(function(r) {
            var n = function() {
              return (
                (n = o), (t = u), (0 === ae((e = r)).length ? Ll : Fl)(n, e, t)
              )
              var n, e, t
            }
    ...
    ef = function(n, e) {
      var t,
        r,
        o = ((t = e), (r = n.document.createRange()), Dl(r, t), r)
      Xl(n, o)
    },
    tf = function(n) {
      return (
      ...
      !1 === r.getParam('table_grid', !0, 'boolean')
        ...
        : r.ui.registry.addNestedMenuItem('inserttable', {
            ...
            getSubmenuItems: function() {
              return [
                { type: 'fancymenuitem', fancytype: 'inserttable', onAction: o }
              ]
            }
          }),

...
!(function(u) {
  ...
  var e,
        ...
        for (; (r = n.firstChild); ) {
          ...
          i ||
            ...
            ze(r, u)
              ...
              : c
              ? (o || ((o = a.create(c)), s.appendChild(o)), o.appendChild(r))
              : s.appendChild(r)
        }
      return (
        c
    ...
    ln =
      (O(u.Element.prototype.attachShadow) && O(u.Node.prototype.getRootNode),
      function(e, n, t) {
        if (!b(t))
          throw (u.console.error(
    ...
    pn = function(e, n) {
      var t,
        ...
        o,
        i,
        a = ((t = e), (r = n), (o = ge.fromTag(r)), (i = dn(t)), fn(o, i), o)
      Ee(e, a)
      var u = De(e)
      return Be(a, u), Re(e), a
    },
    gn = function(e, n) {
      Pe(e.item, n.list)
    },
      ...
      return (
        M(n).each(function(e) {
          ...
          ;(a = c),
            ...
            (i.item = a),
            (s = d),
            Le((u = e).list) !== s.listType &&
              (u.list = pn(u.list, s.listType)),
          ...
          a =
            ...
            B(
              (function(e, n) {
                ...
                for (
                  var t = n(e[0]), r = [], o = [], i = 0, a = e.length;
                  i < a;
                  i++
                ) {
                  var u = e[i],
                    s = n(u)
                  s !== t && (r.push(o), (o = [])), (t = s), o.push(u)
                }
        ...
        : Se(t, 'dt') &&
          Te(t).each(function(e) {
            return (function(e, n, t) {
              ...
              for (
                var a, u = i.extractContents(), s = u.firstChild;
                s;
                s = s.firstChild
              )
          ...
          (function(t, e, r) {
            ...
            return (
              Ue.each(s, function(e) {
                ...
                if (a.isBlock(e) || Qe(e))
                  return Qe(e) && a.remove(e), void (o = null)
                var n = e.nextSibling
    ...
    Gn = function(e, n, t) {
      return (
        ...
        (u = n) &&
          s &&
          He(u) &&
          u.nodeName === s.nodeName &&
          ((i = n),
          (a = t),
          (o = e).getStyle(i, 'list-style-type', !0) ===
            o.getStyle(a, 'list-style-type', !0)) &&
    ...
    at = function(e, n, t) {
      var r,
        o,
        i,
        a = it(e, t) ? t.firstChild : t
      if ((it((o = e), (i = n)) && o.remove(i.firstChild, !0), !Ye(e, n, !0)))
        for (; (r = n.firstChild); ) a.appendChild(r)
    },
    ut = function(n, e, t) {
      var r,
        o = e.parentNode
    ...
    st = function(e, n, t, r) {
      ...
      if (u.isEmpty(r))
        ...
        var s = jn(n)
        ut(u, t, r), e.selection.setRng(qn(s))
      }
    },
    ct = function(n, t) {
      var e = n.dom,
      ...
      if (a) {
        var u = a.parentNode
        if (u === n.getBody() && Ye(e, u)) return !0
        var s = In(r.getRng()),
    ...
    dt = function(e, n) {
      return e.selection.isCollapsed()
        ...
        : ((r = (t = e).selection.getStart()),
          (o = nn(t, r)),
          !!(t.dom.getParent(r, 'LI,DT,DD', o) || 0 < en(t).length) &&

...
!(function(y) {
  ...
  var e,
    ...
    F = tinymce.util.Tools.resolve('tinymce.html.Entities'),
    E = function(e, t, n) {
      var r = e.split(/\n\n/),
        o = (function(e, t) {
          var n,
    ...
    M = tinymce.util.Tools.resolve('tinymce.html.DomParser'),
    N = tinymce.util.Tools.resolve('tinymce.html.Serializer'),
    B = '\xa0',
  ...
  function K(n, r, o, a) {
    ...
    return (
      ...
      /(bold)/i.test(s['font-weight']) &&
        (delete s['font-weight'], o.wrap(new $('b', 1))),
      /(italic)/i.test(s['font-style']) &&
        (delete s['font-style'], o.wrap(new $('i', 1))),
  ...
  var X = function(e, t) {
      return e.getParam('paste_enable_default_filters', !0)
        ? (function(r, e) {
            ...
            var n = r.getParam(
              ...
              a = j({ valid_elements: n, valid_children: '-li[p]' })
            ...
            var s = i.parse(e)
            return (
              r.getParam('paste_convert_word_fake_lists', !0) && V(s),
              (e = N({ validate: k(r) }, a).serialize(s))
            )
          })(e, t)
        : t
    },
    ...
    Y = function(e, t, n, r) {
      var o,
        ...
        h = (function(e, t) {
          ...
          return N({ validate: k(e) }, e.schema).serialize(r)
        })(e, v.content)
      return e.hasEventListeners('PastePostProcess') && !v.isDefaultPrevented()
        ? ((u = h),
          ...
          W(g.node.innerHTML, g.isDefaultPrevented()))
        : W(h, v.isDefaultPrevented())
    },
    Z = function(e, t) {
      return (
        e.insertContent(t, {
        ...
        pcIsSpace: !(o = function(e, t) {
          return -1 !== ' \f\t\x0B'.indexOf(t) || t === B
            ? e.pcIsSpace ||
              ...
              ((n = s), (r = e.str.length + 1) < n.length && 0 <= r && ne(n[r]))
              ? { pcIsSpace: !1, str: e.str + B }
              : { pcIsSpace: !0, str: e.str + ' ' }
            : { pcIsSpace: ne(t), str: e.str + t }
          var n, r
        }),
        str: ''
      }),
    ...
    me = function(e) {
      return (
        (T.metaKeyPressed(e) && 86 === e.keyCode) ||
    ...
    pe = function(s, u, l) {
      ...
      s.on('keydown', function(e) {
        ...
        if (me(e) && !e.isDefaultPrevented()) {
          ...
          if (
            ...
            return (
              e.preventDefault(), (n = !0), void s.fire('paste', { ieFake: n })
            )
          u.remove(),
            u.create(),
            s.once('keyup', t),
      ...
      s.on('paste', function(e) {
        var t,
          n,
          r = f.isSet(),
          o = ((t = s), se(e.clipboardData || t.getDoc().dataTransfer)),
          a = 'text' === l.get() || c,
          i = ue(o, O)
        ;((c = !1),
        e.isDefaultPrevented() ||
          ...
          -1 !== y.navigator.userAgent.indexOf('Android') &&
            ...
            0 === n.items.length))
          ? u.remove()
          : le(o) || !de(s, e, u.getLastRng() || s.selection.getRng())
          ? (r || e.preventDefault(),
            !P.ie ||
              (r && !e.ieFake) ||
              ue(o, 'text/html') ||
      ...
      return {
          ...
          return (function(e, t, n) {
            ...
            ;(P.ie || P.gecko) &&
              r.setStyle(
                a,
                'left',
                'rtl' === r.getStyle(o, 'direction', !0) ? 65535 : -65535
              ),
        ...
        getHtml: function() {
          return (function(n) {
            ...
            for (
              var o = n.dom.select('div[id=mcepastebin]', r), a = o.length - 1;
              0 <= a;
              a--
            ) {
    ...
    Ae = function(i, s, u) {
      i.getParam('paste_block_drop', !1) &&
        ...
        i.on('drop', function(e) {
          ...
          if (!e.isDefaultPrevented() && !u.get()) {
            var n,
              ...
              o = s.hasContentType(r, O)
            if (
              (s.hasHtmlOrText(r) &&
                (!(n = r['text/plain']) || 0 !== n.indexOf('file://'))) ||
        ...
        i.on('dragover dragend', function(e) {
          C(i) && !1 === u.get() && (e.preventDefault(), Re(i, Oe(i, e))),
  ...
  function Fe(e, t) {
    ...
    var n = []
    return (
      I.each(e.schema.getBlockElements(), function(e, t) {
        n.push(t)
      }),
      (t = H(t, [
        [
  ...
  function Ee(e, t, n, r) {
    if (r || n) return t
    var l,
      o = e.getParam('paste_webkit_styles')

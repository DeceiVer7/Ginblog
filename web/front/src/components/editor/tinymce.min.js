  ...
  function Ci(i) {
    ...
    i.valid_elements
      ...
      : (mi(n, function(e, t) {
        ...
        mi(vi('p h1 h2 h3 h4 h5 h6 th td pre div address caption li'), function(
          e
        ) {
          S[e].paddEmpty = !0
        }),
      ...
      (Xm.prototype.empty = function() {
        if (this.firstChild) {
          ...
          for (var n = e.length; n--; )
            (t =
              e[n]).parent = t.firstChild = t.lastChild = t.next = t.prev = null
        }
  ...
  var Ah = kt.each,
    ...
    Xv = function(e, t, n) {
      ...
      var r,
        ...
        i =
          ((r = t),
          ke(ke({ format: 'html' }, n), { set: !0, selection: !0, content: r }))
          ...
          ? (function(e, t, n) {
              ...
              return (
                s.createHTMLDocument &&
                  ...
                  kt.each('BODY' === t.nodeName ? t.childNodes : [t], function(
                    e
                  ) {
